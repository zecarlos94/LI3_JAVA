...
public class Hipermercado implements Serializable
{
    ...
    private ArrayList<String> noParsing;
    ...
    public Hipermercado() {
        ...
        this.noParsing=new ArrayList<String>();
    }
   ...
   public ArrayList<String> getNoParsing() {
       return this.noParsing;
   }
